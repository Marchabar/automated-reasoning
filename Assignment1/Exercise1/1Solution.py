...
if solver.check() == sat:
    model = solver.model()
    print(
        f"1. Investigate what is the maximum number of pallets of dupples that can be delivered, and show how for that number all pallets may be divided over the six trucks."
    )
    print(
